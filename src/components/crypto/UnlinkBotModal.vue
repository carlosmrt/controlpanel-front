  ...
  <v-dialog v-model="coinDialog" max-width="500px">
    <v-card class="roundBorder">
      ...
      <v-card-text>
        ...
        <br/>
        <a
          style="display:block;font-size:16px;font-weight:500;text-align:center;border-radius:8px;padding:5px;background:#389ce9;text-decoration:none;color:#fff;"
          href="https://xn--r1a.click/CryptoBoardBot" target="_blank">
